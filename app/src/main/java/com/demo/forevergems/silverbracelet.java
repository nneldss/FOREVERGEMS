...
public class silverbracelet extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.silverbracelet);
    ...
    public void ComputeResult() {
        ...
        if (checkboxone.isChecked()) {
            ...
            if (rawNumber >= 10) {
                double result = (55000 + addon) * rawNumber;
...
//1000 is price
            ...
            if (rawNumber >= 10) {
                double results = 55000 + addon * rawNumber;
                double percentage = results * 10/100;
                double result = (55000 + addon) * rawNumber - percentage;
