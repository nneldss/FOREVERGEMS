...
public class neck extends AppCompatActivity implements View.OnClickListener {
    ...
    public void ComputeResult() {
        ...
        if (checkboxone.isChecked()) {
            ...
            if (rawNumber >= 10) {
                double result = (250000 + addon) * rawNumber;
...
//1000 is price
            ...
            if (rawNumber >= 10) {
                double results = 250000 + addon * rawNumber;
                double percentage = results * 10/100;
                double result = (250000 + addon) * rawNumber - percentage;
                ...
                double result = (250000 * rawNumber);
                // Casted result to int type, remove to show decimal value
                resultMessage = (int) result + "Thank you for Purchasing our Forever Gem Ring";
